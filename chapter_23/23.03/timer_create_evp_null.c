...
#define PROGRAM_NAME "timer_create_evp_null"
...
void sighandler(int sig, siginfo_t *si, void *uc) {
    ...
    printf("sighandler, sig=%d, correct=%d, timer_id=%ld",
           sig, si->si_value.sival_ptr == timer_id, (long) timer_id);
    printf(", si->si_value.sival_ptr=%ld\n", (long) si->si_value.sival_ptr);
    exit(EXIT_SUCCESS);
}
...
int main(int argc, char *argv[]) {
    ...
    // create timer
    my_timer_create(CLOCK_REALTIME, NULL, &timer_id);
